...
public class CloudletSimple extends CloudletAbstract {
     ...
     * @param amountOfRam 
     */
    public CloudletSimple(final long id, final long length, final long pesNumber, long amountOfRam) {
        super(id, length, pesNumber,amountOfRam);
    }

    public CloudletSimple(int id, long length, int pesNumber) {
    	super(id, length, pesNumber);
	}

	public CloudletSimple(int id, long length, long numberOfCpuCores) {
		super(id, length, numberOfCpuCores);
	}

	public CloudletSimple(long id, long length, int pesNumber) {
		super(id, length, pesNumber);
	}
