...
public abstract class CloudletAbstract extends CustomerEntityAbstract implements Cloudlet {
     ...
     */
    public CloudletAbstract(final long id, final long length, final long pesNumber, final long amountOfRam ) {
        /*
        ...
        */
        ...
        this.setAmountOfRam(amountOfRam);
     ...
     * @param pesNumber number of PEs that Cloudlet will require
     */
    public CloudletAbstract(final long length, final int pesNumber,final int ramAmount) {
        this(-1, length, pesNumber,ramAmount);
    }
     ...
     * @param pesNumber number of PEs that Cloudlet will require
     */
    public CloudletAbstract(final long length, final long pesNumber,final int ramAmount) {
        this(-1, length, pesNumber,ramAmount);
    }
    ...
    public final Cloudlet setAmountOfRam(final long amountOfRam) {
        if (amountOfRam <= 0) {
            throw new IllegalArgumentException("Cloudlet amount of Ram has to be greater than zero.");
        }
